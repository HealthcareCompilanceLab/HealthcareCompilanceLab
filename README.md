...
## Week 7 Update - Contingency Planning and Recovery Readiness 
Last week, we began the process of adding contingency planning and recovery readiness checks to the Healthcare Data Security Compliance Checker. This update expands the project beyond checking whether backups exist. The tool will evaluate whether the organization has practical recovery safeguards in place in case of system outages, ransomware incidents, backup failure, or healthcare service disruption. To do this, we will add encrypted backups, backup restoration testing, disaster recovery planning, downtime procedures, ransomware recovery steps, crticial system identification, recovery evidence documentation, backup retention practices. 
